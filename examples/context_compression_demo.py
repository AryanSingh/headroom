...
Tests REAL Cutctx compression on realistic retriever tool outputs.
...
def main() -> None:
    print("=" * 70)
    print("Context Compression Demo (Real Cutctx, No Mocks)")
    print("=" * 70)
    ...
    # --- Compress with REAL Cutctx ---
    from cutctx import compress

    print("\nCompressing with Cutctx (real compress() call)...")
    ...
    print(f"  {'07-Cutctx Compression':<35} {hr_tokens:<10} {hr_pct:<10} {'No':<18} {'$0'}")
