...
# See headroom_ee/LICENSE (Headroom Commercial License) and ../LICENSING.md.
"""headroom_ee — Headroom commercial ("enterprise edition") components.
...
governed by the Headroom Commercial License (``headroom_ee/LICENSE``).
