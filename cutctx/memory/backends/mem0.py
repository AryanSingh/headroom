...
from cutctx.memory.ports import MemoryFilter, VectorFilter, VectorSearchResult
...
class Mem0Config:
    ...
    # Collection settings
    collection_name: str = "cutctx_memories"
...
class Mem0Backend:
    ...
    async def _ensure_client(self) -> Any:
        ...
        if self._client is None:
            try:
                ...
                raise ImportError(
                    "mem0 package not installed. Install with: pip install 'cutctx-ai[memory-stack]'"
                ) from None
    ...
    def _mem0_result_to_memory(self, result: dict[str, Any]) -> Memory:
        ...
        memory_id = metadata.get("cutctx_id", result.get("id", str(uuid.uuid4())))
