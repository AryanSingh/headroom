...
from cutctx.memory.sync_adapters.claude_code import encode_claude_project_path
from cutctx.memory.writers.base import AgentWriter, MemoryEntry
...
class ClaudeCodeMemoryWriter(AgentWriter):
    ...
    def export_topics(
        ...
        for category, entries in grouped.items():
            ...
            filename = f"cutctx_{category}.md"
            lines = [
                "---",
                f"name: cutctx-{category}",
