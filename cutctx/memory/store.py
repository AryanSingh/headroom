...
Stores session insights as Markdown files in ``~/.cutctx/memories/``.
...
_DEFAULT_MEMORY_DIR = "~/.cutctx/memories"
...
class EpisodicMemoryStore:
    ...
    def __init__(self, memory_dir: str | Path | None = None) -> None:
        if memory_dir is None:
            memory_dir = os.environ.get("CUTCTX_EPISODIC_MEMORY_DIR", _DEFAULT_MEMORY_DIR)
