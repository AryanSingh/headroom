...
Advanced Usage - LLM Wrapper:
    ...
    from cutctx.memory import with_memory
...
Advanced Usage - Tool-based:
    from openai import OpenAI
    from cutctx.memory import with_memory_tools, LocalBackend
...
# =============================================================================
from cutctx.memory.easy import Memory, MemoryResult
...
# =============================================================================
from cutctx.memory.models import Memory as MemoryModel
...
# =============================================================================
from cutctx.memory.system import MemoryBackend, MemorySystem

# =============================================================================
# Memory tools for LLM function calling
# =============================================================================
from cutctx.memory.tools import (
    MEMORY_TOOLS,
...
# =============================================================================
from cutctx.memory.wrapper import MemoryWrapper, with_memory

# =============================================================================
# Tool-based wrapper for LLM clients
# =============================================================================
from cutctx.memory.wrapper_tools import MemoryToolsWrapper, with_memory_tools
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0Backend":
        if _Mem0Backend is None:
            from cutctx.memory.backends.mem0 import Mem0Backend
    ...
    if name == "DirectMem0Adapter":
        if _DirectMem0Adapter is None:
            from cutctx.memory.backends.direct_mem0 import DirectMem0Adapter
    ...
    if name == "DirectMem0Config":
        if _DirectMem0Config is None:
            from cutctx.memory.backends.direct_mem0 import Mem0Config as DirectMem0Config
