...
# Marker delimiters for Cutctx-managed sections
_MARKER_START = "<!-- cutctx:learn:start -->"
_MARKER_END = "<!-- cutctx:learn:end -->"
...
def _build_section(recommendations: list[Recommendation]) -> str:
    ...
    lines = [
        _MARKER_START,
        f"<!-- provenance: source=learn, created_at={timestamp} -->",
        "## Cutctx Learned Patterns",
        f"*Auto-generated by `cutctx learn` on {now} — do not edit manually*",
        "",
    ]
...
def extract_marker_block(file_content: str) -> str | None:
    """Return the raw text of the cutctx:learn marker block, or None.
