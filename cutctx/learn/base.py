"""Base class for cutctx learn plugins.
...
class LearnPlugin(ABC):
    ...
    Plugins are discovered automatically from cutctx.learn.plugins.*
    or via ``cutctx.learn_plugin`` entry points for external packages.
    ...
    Example::
        ...
        class MyAgentPlugin(LearnPlugin, ConversationScanner):
            ...
            def create_writer(self) -> ContextWriter:
                from cutctx.learn.writer import GeminiWriter
