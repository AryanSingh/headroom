...
def integrations_status(output_format: str) -> None:
    ...
    in_process_adapters = {
        "litellm": "cutctx.savings.integrations.parse_litellm_cache",
        "vllm_apc": "cutctx.savings.integrations.parse_vllm_apc",
        "gptcache": "cutctx.savings.integrations.parse_gptcache_hit",
        "model_routing": "cutctx.savings.integrations.parse_model_routing_metadata",
    }
    ...
    for name, dotted in in_process_adapters.items():
        ...
        integration_status[name] = {
            ...
            "wiring": "x-cutctx-savings-metadata",
            **(
...
def integrations_test(provider: str, output_format: str) -> None:
    ...
    if p in _PROVIDER_FIXTURES:
        from cutctx.savings import parse_provider_savings
