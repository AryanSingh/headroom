...
class TestCompressionProfile:
    ...
    def test_save_and_load(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch("cutctx.profiles._get_profile_path", return_value=expected_path):
                profile.save()
...
class TestWorkspaceHash:
    ...
    def test_get_profile_path(self):
        ...
        assert ".cutctx/profiles" in str(path)
...
class TestIntegration:
    ...
    def test_full_lifecycle(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch("cutctx.profiles._get_profile_path", return_value=profile_path):
                profile.save()
