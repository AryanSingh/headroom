...
from cutctx.context_budget import (
    BudgetPolicy,
    BudgetStatus,
    BudgetZone,
...
class TestBudgetPolicy:
    ...
    def test_from_env_no_env_vars(self, monkeypatch):
        ...
        for key in [
            "CUTCTX_BUDGET_GREEN",
            "CUTCTX_BUDGET_YELLOW",
            "CUTCTX_BUDGET_RED",
            "CUTCTX_BUDGET_WINDOW_YELLOW",
            "CUTCTX_BUDGET_WINDOW_RED",
        ]:
    ...
    def test_from_env_explicit_vars(self, monkeypatch):
        ...
        monkeypatch.setenv("CUTCTX_BUDGET_GREEN", "0.55")
        monkeypatch.setenv("CUTCTX_BUDGET_YELLOW", "0.78")
        monkeypatch.setenv("CUTCTX_BUDGET_RED", "0.92")
        monkeypatch.setenv("CUTCTX_BUDGET_WINDOW_YELLOW", "12")
        monkeypatch.setenv("CUTCTX_BUDGET_WINDOW_RED", "6")
