...
come from the environment at cutctx start-up.
...
class _CopilotQuotaTracker(QuotaTracker):
    ...
    Implements :class:`~cutctx.subscription.base.QuotaTracker` so it can be
    registered with the :class:`~cutctx.subscription.base.QuotaTrackerRegistry`.
    ...
    async def _poll_loop(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                # note in cutctx/subscription/tracker.py:_poll_loop.
