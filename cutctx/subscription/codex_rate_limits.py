...
headers from responses that cutctx proxies and makes them available in
...
class CodexRateLimitState(QuotaTracker):
    ...
    be registered with the :class:`~cutctx.subscription.base.QuotaTrackerRegistry`.
    ...
    cutctx, so :meth:`start` and :meth:`stop` are no-ops.
    """
