...
from .providers import get_cutctx_provider, get_model_name_from_langchain
...
def _check_langchain_available() -> None:
    ...
    if not LANGCHAIN_AVAILABLE:
        raise ImportError(
            ...
            "Install with: pip install cutctx[langchain] "
...
class CutctxChatModel(BaseChatModel):
    ...
    Attributes:
        ...
        cutctx_client: CutctxClient instance for optimization
    ...
    cutctx_config: Any = Field(default=None, description="Cutctx configuration")
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(  # type: ignore[call-arg]
            ...
            cutctx_config=config or CutctxConfig(),
            mode=mode,
    ...
    def _llm_type(self) -> str:
        ...
        return f"cutctx-{self.wrapped_model._llm_type}"
    ...
    def pipeline(self) -> TransformPipeline:
        ...
        if self._pipeline is None:
            if self.auto_detect_provider:
                self._provider = get_cutctx_provider(self.wrapped_model)
...
class CutctxRunnable:
    ...
    Example:
        ...
        from cutctx.integrations import CutctxRunnable
