...
Example:
    ...
    from cutctx.integrations.langchain import get_cutctx_provider

    model = ChatAnthropic(model="claude-3-5-sonnet-20241022")
    provider = get_cutctx_provider(model)  # Returns AnthropicProvider
"""
...
def get_cutctx_provider(model: Any) -> Provider:
