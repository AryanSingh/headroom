...
Example:
    ...
    # Traces will include cutctx.* metadata
...
class CutctxLangSmithCallbackHandler(BaseCallbackHandler):
    ...
    def _attach_metrics_to_run(self, run_id: str, metrics: PendingMetrics) -> None:
        ...
        """
        metadata = {
            "cutctx.tokens_before": metrics.tokens_before,
            "cutctx.tokens_after": metrics.tokens_after,
            "cutctx.tokens_saved": metrics.tokens_saved,
            "cutctx.savings_percent": round(metrics.savings_percent, 2),
            "cutctx.transforms_applied": metrics.transforms_applied,
            "cutctx.optimization_timestamp": metrics.timestamp.isoformat(),
        }
    ...
    def get_run_metrics(self, run_id: str | UUID) -> dict[str, Any]:
        ...
        Returns:
            Dictionary of cutctx.* metrics for the run.
        """
