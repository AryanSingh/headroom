...
class CutctxHookProvider(HookProvider):  # type: ignore[misc]
    ...
    def __post_init__(self) -> None:
        ...
        logger.debug(
            "CutctxHookProvider initialized: compress=%s, min_tokens=%d, preserve_errors=%s",
    ...
    def register_hooks(self, registry: HookRegistry, **kwargs: Any) -> None:
        ...
        logger.info(
            "CutctxHookProvider registered: compressing tool outputs >= %d tokens",
            self.min_tokens_to_compress,
        )
    ...
    def reset(self) -> None:
        ...
        logger.debug("CutctxHookProvider metrics reset")
