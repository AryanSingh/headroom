...
3. get_cutctx_provider - Detects appropriate provider for a Strands model
...
if TYPE_CHECKING:
    ...
    from .providers import get_cutctx_provider, get_model_name_from_strands
...
def __getattr__(name: str) -> Any:
    ...
    if name == "CutctxHookProvider":
        from .hooks import CutctxHookProvider

        return CutctxHookProvider
    elif name in ("CutctxStrandsModel", "CutctxStrandsModel"):
    ...
    # Backward-compat aliases (pre-db7f7a4 rebrand).
        ...
        if name in ("CutctxHookProvider", "CutctxHookProvider"):
