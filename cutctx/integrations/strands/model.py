...
from cutctx import CutctxConfig  # noqa: E402
from cutctx.providers import OpenAIProvider  # noqa: E402
from cutctx.transforms import TransformPipeline  # noqa: E402

from .providers import get_cutctx_provider, get_model_name_from_strands  # noqa: E402
...
class CutctxStrandsModel(Model):  # type: ignore[misc]
    ...
    def __init__(
        ...
        self.cutctx_config = config or CutctxConfig()
        ...
        self._cutctx_provider: Any = None
