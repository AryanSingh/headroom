...
When the LLM calls cutctx_retrieve, this handler:
...
class CCRResponseHandler:
    ...
    Example flow:
    1. LLM response contains: tool_use(cutctx_retrieve, hash=abc123)
            ...
            if ccr_call.query:
                ...
                if entry:
                    ...
                    try:
                        ...
                        from cutctx.telemetry.episodes import EpisodeStore, RetrievalLabel
        ...
        while rounds < self.config.max_retrieval_rounds:
            ...
            if other_calls:
                logger.warning(
                    ...
                    "alongside cutctx_retrieve. Cannot create a valid continuation "
