...
Requires the [ml] extra: pip install cutctx-ai[ml]
...
KOMPRESS_BACKEND_ENV = "CUTCTX_KOMPRESS_BACKEND"
KOMPRESS_ONNX_FILENAME_ENV = "CUTCTX_KOMPRESS_ONNX_FILENAME"
...
#
# An operator can pin an exact file via CUTCTX_KOMPRESS_ONNX_FILENAME.
_DEFAULT_ONNX_FILENAMES = (
    "onnx/kompress-int8-wo.onnx",
    "onnx/kompress-fp32.onnx",
    "onnx/kompress-int8.onnx",
)
KOMPRESS_ONNX_INTRA_THREADS_ENV = "CUTCTX_KOMPRESS_ONNX_INTRA_THREADS"
KOMPRESS_ONNX_INTER_THREADS_ENV = "CUTCTX_KOMPRESS_ONNX_INTER_THREADS"
KOMPRESS_COREML_CACHE_DIR_ENV = "CUTCTX_KOMPRESS_COREML_CACHE_DIR"
...
def _load_kompress(
    ...
    # allowing opt-in MPS/CoreML experiments via CUTCTX_KOMPRESS_BACKEND.
    if _is_onnx_available():
        try:
            return _load_kompress_onnx(model_id, use_coreml=False, allow_download=allow_download)
        except KompressModelNotCached:
    ...
    raise ImportError(
        "Kompress requires onnxruntime or torch. Install with: pip install cutctx-ai[proxy]"
    )
