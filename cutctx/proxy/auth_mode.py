...
Direct port of ``crates/cutctx-core/src/auth_mode.rs``. The two
...
class AuthMode(str, enum.Enum):
    ...
    #: ``accept-encoding``, never strip; never inject ``X-Cutctx-*``;
...
# short normalized client name. The dashboard / `cutctx perf` use
...
CLIENT_UA_MAP: tuple[tuple[str, str], ...] = (
    ...
    # explicitly (see `cutctx/integrations/strands/README.md`).
