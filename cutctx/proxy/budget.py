...
logger = logging.getLogger("cutctx.proxy.budget")
...
class BudgetConfig:
    ...
    def from_env(cls) -> BudgetConfig:
        ...
        return cls(
            ...
            default_budget_usd=float(os.environ.get("CUTCTX_BUDGET_USD", "10.0")),
            hard_limit=os.environ.get("CUTCTX_BUDGET_HARD_LIMIT", "1").strip() != "0",
        )
