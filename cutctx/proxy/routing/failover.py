...
logger = logging.getLogger("cutctx.proxy.routing.failover")
...
_PROVIDERS_ENV = "CUTCTX_PROVIDERS"
...
def failover_router_from_env(
    ...
    Reads ``CUTCTX_PROVIDERS`` as a JSON array of provider config objects::
