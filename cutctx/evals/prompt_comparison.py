...
Usage:
    from cutctx.evals.prompt_comparison import compare_prompts, PromptComparer

    # Simple comparison
    result = compare_prompts(
        original_prompt="What is the capital of France?",
        cutctx_modified_prompt="What is the capital of France?",
    )
...
class PromptComparisonResult:
    ...
    Attributes:
        ...
        cutctx_modified: The prompt after Cutctx processing.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "cutctx_modified": self.cutctx_modified,
    ...
    def from_dict(cls, data: dict[str, Any]) -> PromptComparisonResult:
        ...
        return cls(
            ...
            cutctx_modified=data["cutctx_modified"],
...
def compare_prompts(
    ...
    Args:
        ...
        cutctx_modified_prompt: The prompt after Cutctx processing.
    ...
    Example:
        result = compare_prompts(
            ...
            cutctx_modified_prompt="Explain quantum computing in simple terms.",
        )
    ...
    judge_prompt = SEMANTIC_EQUIVALENCE_JUDGE_PROMPT.format(
        ...
        modified_prompt=cutctx_modified_prompt,
    )
    ...
    return PromptComparisonResult(
        ...
        cutctx_modified=cutctx_modified_prompt,
...
class PromptComparer:
    ...
    def compare(
        ...
        result = compare_prompts(
            original_prompt=original_prompt,
            cutctx_modified_prompt=cutctx_modified_prompt,
            judge_model=self.judge_model,
    ...
    def compare_and_log(
        ...
        Returns:
            PromptComparisonResult with the comparison outcome.
        """
        result = self.compare(original_prompt, cutctx_modified_prompt, metadata)
...
def compare_messages(
    ...
    result = compare_prompts(
        ...
        cutctx_modified_prompt=modified_str,
        judge_model=judge_model,
        api_key=api_key,
        metadata={
...
def batch_compare_prompts(
    ...
    def compare_pair(
        ...
        result = compare_prompts(
            ...
            cutctx_modified_prompt=modified,
            judge_model=judge_model,
            api_key=api_key,
...
def verify_cutctx_preservation(
    original_messages: list[dict[str, Any]],
    cutctx_messages: list[dict[str, Any]],
    judge_model: str = "gpt-4o",
    api_key: str | None = None,
    ...
    Args:
        ...
        cutctx_messages: Messages after Cutctx processing.
        judge_model: The model to use for judging.
        api_key: OpenAI API key.
    ...
    Example:
        ...
        after_cutctx = [{"role": "user", "content": "Hello, how are you?"}]

        result = verify_cutctx_preservation(
            original, after_cutctx, fail_on_difference=True
        )
    """
    result = compare_messages(
        original_messages=original_messages,
        modified_messages=cutctx_messages,
        judge_model=judge_model,
        api_key=api_key,
    )
