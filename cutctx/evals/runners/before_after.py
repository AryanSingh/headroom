...
from cutctx.evals.metrics import compute_semantic_similarity
from cutctx.transforms.content_router import ContentRouter, ContentRouterConfig
from cutctx.transforms.smart_crusher import SmartCrusherConfig
...
class LLMConfig:
    ...
    max_tokens: int = 1024
    cutctx_proxy_url: str | None = None  # e.g. "http://localhost:8787" for full-stack eval
...
class BeforeAfterRunner:
    ...
    def __init__(
        ...
        if self.llm_config.cutctx_proxy_url:
    ...
    def _init_proxy_client(self) -> Any:
        ...
        return openai.OpenAI(
            base_url=f"{self.llm_config.cutctx_proxy_url}/v1",
...
Answer:"""
    ...
    def evaluate_case(
        ...
        """
        from cutctx.evals.metrics import compute_exact_match, compute_f1
    ...
    def _evaluate_ground_truth(
        ...
        """
        from cutctx.evals.metrics import compute_f1
        ...
        if case.ground_truth:
            try:
                if self._judge_fn is None:
                    from cutctx.evals.memory.judge import create_openai_judge
