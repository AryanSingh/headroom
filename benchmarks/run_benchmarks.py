#!/usr/bin/env python3
"""CLI runner for Cutctx benchmark suite.

This script provides a convenient interface for running benchmarks and
generating reports. It wraps pytest-benchmark with Cutctx-specific
...
def generate_markdown_report(
    ...
    # Header
    lines.append("# Cutctx SDK Benchmark Report")
    lines.append("")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Run Cutctx SDK benchmarks",
