...
- *Q: Target upstream or the fork?* Resolved: target the fork (`fix/responses-retries-keep-compression`), structured so each unit is cherry-pickable into a PR against `cutctx/cutctx#172`.
...
- Related PRs/issues:
  - Upstream: `https://github.com/cutctx/cutctx/issues/172`
