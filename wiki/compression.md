...
Cutctx's Universal Compression module provides intelligent, automatic compression with ML-based content detection and structure preservation.
...
```python
from cutctx.compression import compress
...
```python
from cutctx.compression import UniversalCompressor, UniversalCompressorConfig
...
```python
from cutctx.compression import UniversalCompressorConfig
...
```python
from cutctx.compression import UniversalCompressor
...
from cutctx.compression.handlers.base import BaseStructureHandler, HandlerResult
from cutctx.compression.masks import StructureMask
