...
For coding tasks, Cutctx provides **standalone text compression utilities** that applications can use explicitly. These are **opt-in** — they're not applied automatically, giving you full control over when and how to compress text content.
...
```python
from cutctx.transforms import SearchCompressor
...
```python
from cutctx.transforms import LogCompressor
...
```python
from cutctx.transforms import TextCompressor
...
```python
from cutctx.transforms import detect_content_type, ContentType
...
```python
from cutctx.transforms import SearchCompressor, SearchCompressorConfig
