...
intellijPlatform {
    ...
    pluginVerification {
        ides {
            ...
            ide(providers.gradleProperty("platformType").get(), "2024.1")
            ide(providers.gradleProperty("platformType").get(), "2024.3")
            ide(providers.gradleProperty("platformType").get(), "2025.1")
        }
    }
}
