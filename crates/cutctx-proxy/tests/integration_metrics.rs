...
use cutctx_proxy::observability;
use cutctx_proxy::sse::openai_responses::ResponseState;
use cutctx_proxy::sse::SseFramer;
use serde_json::json;
...
async fn passthrough_bytes_modified_zero_when_no_compression() {
    ...
    use cutctx_proxy::observability::record_passthrough_bytes_modified;
...
fn service_tier_validate_known_returns_canonical_constant() {
    use cutctx_proxy::observability::metric_names::service_tier;
...
async fn compression_ratio_per_strategy_does_not_replicate_aggregate() {
    ...
    use cutctx_proxy::observability::observe_compression_ratio;
