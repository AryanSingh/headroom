...
//! the Anthropic Messages spec (and the Cutctx realignment guide
//! §5.1) requires.
//!
...
use bytes::Bytes;
use cutctx_proxy::sse::anthropic::{AnthropicStreamState, StreamStatus};
...
#[allow(dead_code)]
fn _ref_event() -> cutctx_proxy::sse::SseEvent {
    cutctx_proxy::sse::SseEvent {
        event_name: None,
