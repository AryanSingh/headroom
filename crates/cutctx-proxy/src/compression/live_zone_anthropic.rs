...
//! [`cutctx_core::transforms::LiveZoneOutcome`] and the
...
//!    [`cutctx_core::transforms::compress_anthropic_live_zone`].
...
//! `crates/cutctx-core/tests/live_zone_dispatch.rs` pins the
