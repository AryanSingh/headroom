...
//!
//! Mirrors `MODEL_PATTERNS` in `cutctx/tokenizers/registry.py`. Three
...
///
/// Patterns and ordering match `cutctx.tokenizers.registry.MODEL_PATTERNS`
...
///
/// ```no_run
/// use cutctx_core::tokenizer::try_register_hf;
