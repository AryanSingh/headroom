//! Token counting for Cutctx transforms.
//!
//! Mirrors the public surface of the Python `cutctx.tokenizers` package:
...
//!
//! # What this is NOT
//! - Not used by `cutctx-proxy` yet (Stage 2 is library-only; no production
//!   wiring).
