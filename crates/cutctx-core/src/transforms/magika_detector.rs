...
//! and maps its 200+ labels onto Cutctx's existing
...
/// Classify `content` and return the mapped Cutctx [`ContentType`].
///
...
/// Map a magika label string to Cutctx's [`ContentType`] enum.
///
