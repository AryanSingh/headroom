//! Unified-diff compressor — Rust port of `cutctx.transforms.diff_compressor`.
//!
...
/// Priority patterns matching `cutctx.transforms.error_detection.PRIORITY_PATTERNS_DIFF`:
...
/// `cutctx.cache.compression_store.CompressionStore.store`.
