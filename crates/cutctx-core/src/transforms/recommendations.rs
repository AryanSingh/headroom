...
//!
//! 1. The Python `cutctx.cli.toin_publish` CLI walks the on-disk TOIN
...
/// not propagate.
pub const RECOMMENDATIONS_PATH_ENV_VAR: &str = "CUTCTX_RECOMMENDATIONS_PATH";
...
///
/// Honors `CUTCTX_RECOMMENDATIONS_PATH` for prod overrides; falls
