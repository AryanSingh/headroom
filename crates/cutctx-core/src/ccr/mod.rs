...
//! end-to-end.
//!
//! Mirrors the semantics of Python's [`CompressionStore`] (`cutctx/
...
//!
//! [`CompressionStore`]: https://github.com/chopratejas/cutctx/blob/main/cutctx/cache/compression_store.py
...
pub fn compute_key(payload: &[u8]) -> String {
    ...
    // (`[a-f0-9]{16}`) — see `cutctx/ccr/tool_injection.py:211`.
...
/// calls `cutctx_retrieve`. Format is intentionally fixed across
