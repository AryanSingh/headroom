...
impl TransformComparator for DiffCompressorComparator {
    ...
    fn run(
        ...
        use cutctx_core::transforms::{DiffCompressor, DiffCompressorConfig};
...
/// `cutctx.providers.openai.OpenAITokenCounter("gpt-4o-mini")`, so the
...
impl TransformComparator for TokenizerComparator {
    ...
    fn run(
        ...
        use cutctx_core::tokenizer::{TiktokenCounter, Tokenizer};
        let text = input
            .as_str()
...
impl TransformComparator for SmartCrusherComparator {
    ...
    fn run(
        ...
        use cutctx_core::transforms::smart_crusher::{SmartCrusher, SmartCrusherConfig};
...
impl TransformComparator for ContentDetectorComparator {
    ...
    fn run(
        ...
        use cutctx_core::transforms::detect_content_type;
