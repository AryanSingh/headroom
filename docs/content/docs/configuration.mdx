...
| `HEADROOM_BASE_URL` | Base URL of the CutCtx proxy (TypeScript SDK) | `http://localhost:8787` |
| `HEADROOM_API_KEY` | API key for CutCtx Cloud authentication | -- |
