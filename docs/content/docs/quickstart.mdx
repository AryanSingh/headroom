...
The biggest savings come from tool outputs -- search results, database rows, log files, API responses. Cutctx auto-detects the content type and routes it to the best compressor. No configuration needed.
