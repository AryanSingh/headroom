...
The old LLMLingua proxy toggles are no longer part of the CLI. Cutctx's proxy compression path uses ContentRouter plus the current built-in compressors, including Kompress where applicable.
</Callout>
