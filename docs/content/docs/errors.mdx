...
```ts twoslash
import { compress, HeadroomConnectionError, HeadroomAuthError, HeadroomCompressError, HeadroomError } from 'cutctx-ai';
...
```ts twoslash
import { compress, HeadroomConnectionError } from 'cutctx-ai';
...
<Tab value="TypeScript">
```ts twoslash
import { HeadroomError } from 'cutctx-ai';
