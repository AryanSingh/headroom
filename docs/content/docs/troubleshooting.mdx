...
4. File an issue at [github.com/AryanSingh/headroom](https://github.com/AryanSingh/headroom/issues) with your CutCtx version, Python version, provider, debug log output, and minimal reproduction code
