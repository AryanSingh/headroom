...
## `cutctx evals benchmark` — 2026-07-01

Datasets: ToolOutputSamples · Compressors: code, content_router, diff, drain3, html, kompress, llmlingua, log, search, smart_crusher · Seed: 42

# Cutctx Compressor Benchmark Report

Seed: `42` | Duration: 19.3s | Datasets: ToolOutputSamples
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| ToolOutputSamples | 3 | 79.0% | 86.9% | 100.0% | 107.4% | 0.0% | 79.0% | 40.6% | 100.0% | 71.8% | 89.5% |
...
| Dataset | N | Code | ContentRouter | Diff | Drain3 | HTML | Kompress | LLMLingua | Log | Search | SmartCrusher |
|---|---|---|---|---|---|---|---|---|---|---|---|
| ToolOutputSamples | 3 | 0.998 | 0.998 | 1.000 | 0.922 | 0.000 | 0.998 | 0.705 | 1.000 | 0.817 | 1.000 |
...
| Dataset | N | Code | ContentRouter | Diff | Drain3 | HTML | Kompress | LLMLingua | Log | Search | SmartCrusher |
|---|---|---|---|---|---|---|---|---|---|---|---|
| ToolOutputSamples | 3 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 | 1.000 | 0.617 | 1.000 | 0.778 | 1.000 |


_Generated by `cutctx evals benchmark`_

## `cutctx evals benchmark` — 2026-07-04

Datasets: ToolOutputSamples · Compressors: smart_crusher, content_router, log, search, diff, code, drain3 · Seed: 42

# Cutctx Compressor Benchmark Report

Seed: `42` | Duration: 5.1s | Datasets: ToolOutputSamples

## Compression Ratio by Dataset × Compressor

| Dataset | N | SmartCrusher | ContentRouter | Log | Search | Diff | Code | Drain3 |
|---|---|---|---|---|---|---|---|---|
| ToolOutputSamples | 3 | 89.5% | 86.9% | 100.0% | 71.8% | 100.0% | 79.0% | 107.4% |
...
| Dataset | N | SmartCrusher | ContentRouter | Log | Search | Diff | Code | Drain3 |
|---|---|---|---|---|---|---|---|---|
| ToolOutputSamples | 3 | 1.000 | 0.998 | 1.000 | 0.817 | 1.000 | 0.998 | 0.922 |
...
| Dataset | N | SmartCrusher | ContentRouter | Log | Search | Diff | Code | Drain3 |
|---|---|---|---|---|---|---|---|---|
| ToolOutputSamples | 3 | 1.000 | 1.000 | 1.000 | 0.778 | 1.000 | 1.000 | 1.000 |
