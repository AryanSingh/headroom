...
# 2026-07-19 merged-main QA addendum

Evidence: local core pytest gate passed on `main` at `885cc6f9`; current
uncommitted files are user-owned and excluded. Remaining verification: rerun
the historic failed Docker-native, browser-evidence, and shard jobs on main.
