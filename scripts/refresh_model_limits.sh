...
# used by `crates/cutctx-proxy/src/compression/model_limits.rs`.
#
...
DEST="$REPO_ROOT/crates/cutctx-proxy/data/model_prices_and_context_window.json"
...
echo "Updated $DEST"
echo "Run 'cargo test -p cutctx-proxy --lib compression::model_limits' to verify."
