 ...
 *
 * Run: CUTCTX_INTEGRATION=1 npx vitest run test/vercel-ai-e2e.test.ts
 */
...
describe.skipIf(!RUN)("E2E: Vercel AI SDK + Cutctx", () => {
  ...
  it("cutctxMiddleware() transparently compresses before LLM call (OpenAI)", { timeout: 30000 }, async () => {
