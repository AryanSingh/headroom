 ...
 *
 * Run: CUTCTX_INTEGRATION=1 npx vitest run test/mdx-examples.test.ts
 */
...
const RUN = process.env.CUTCTX_INTEGRATION === "1";

describe.skipIf(!RUN)("MDX Examples: 51-cutctx.mdx", () => {
  beforeAll(async () => {
  ...
  // =====================================================
  // Example 1 from 51-cutctx.mdx: "Compress messages before calling the model"
  // =====================================================
  ...
  // =====================================================
  // Example 2 from 51-cutctx.mdx: "Use as middleware"
  // =====================================================
  it("cutctxMiddleware() with wrapLanguageModel → generateText()", { timeout: 30000 }, async () => {
    const { cutctxMiddleware } = await import("../src/adapters/vercel-ai.js");
    ...
    const model = wrapLanguageModel({
      model: openai("gpt-4o-mini"),
      middleware: cutctxMiddleware({ baseUrl: PROXY_URL }),
    });
  ...
  // =====================================================
  // Example 3 from 51-cutctx.mdx: "Works with any provider" (Anthropic)
  // =====================================================
