...
class ActivationRecord:
    ...
    fingerprint: str
    ip_address: str
    geo: str | None = None  # Country/region code (e.g., "US", "EU")
...
class AbuseDetector:
    ...
    def _check_impossible_travel(self, record: ActivationRecord) -> AbuseAlert | None:
    ...
    def _check_fingerprint_count(self, record: ActivationRecord) -> AbuseAlert | None:
    ...
    def _check_ip_count(self, record: ActivationRecord) -> AbuseAlert | None:
    ...
    def _check_activation_storm(self, record: ActivationRecord) -> AbuseAlert | None:
    ...
    def clear_history(self, lic_id: str | None = None):
