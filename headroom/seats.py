...
try:
    import headroom_ee.seats as _impl
except ImportError as _e:  # commercial component not installed (community edition)
    raise ImportError(
        "headroom.seats requires the proprietary 'headroom_ee' distribution "
...
if TYPE_CHECKING:
    ...
    # sys.modules rebind above makes `from headroom.seats import X` resolve to
    # headroom_ee.seats; this makes the same names visible to static analysis.
    from headroom_ee.seats import *  # noqa: F401,F403
