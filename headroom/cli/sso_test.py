...
@click.option("--provider-type", type=click.Choice(["oidc", "introspection"]), envvar="HEADROOM_SSO_PROVIDER_TYPE", help="SSO provider type")
@click.option("--discovery-url", envvar="HEADROOM_SSO_DISCOVERY_URL", help="OIDC discovery URL")
@click.option("--jwks-uri", envvar="HEADROOM_SSO_JWKS_URI", help="JWKS URI")
@click.option("--issuer", envvar="HEADROOM_SSO_ISSUER", help="Expected issuer")
@click.option("--audience", envvar="HEADROOM_SSO_AUDIENCE", help="Expected audience")
@click.option("--introspection-url", envvar="HEADROOM_SSO_INTROSPECTION_URL", help="Token introspection URL")
def sso_test(
    ...
    if not provider_type:
        ...
        click.echo("Set HEADROOM_SSO_PROVIDER_TYPE=oidc or --provider-type oidc")
        return
