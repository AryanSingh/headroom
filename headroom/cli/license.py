...
logger = logging.getLogger("headroom.cli.license")
...
def activate(license_key: str, cloud_url: str, no_browser: bool) -> None:
    ...
    from headroom.entitlements import EntitlementTier
    ...
    if resp.status_code == 200:
        ...
        from headroom.security.state_crypto import write_hmac_json
