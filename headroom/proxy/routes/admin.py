...
logger = logging.getLogger("headroom.proxy.routes.admin")
...
def create_admin_router(
    ...
    *,
    ...
    async def subscription_window():
        ...
        from headroom.proxy.subscription import get_subscription_tracker
    ...
    async def quota():
        ...
        from headroom.proxy.quota import get_quota_registry
    ...
    async def ccr_feedback():
        ...
        from headroom.cache.compression_store import get_compression_feedback
    ...
    async def telemetry_stats():
        ...
        from headroom.cache.compression_store import get_telemetry_collector
    ...
    async def toin_stats():
        ...
        from headroom.cache.compression_store import get_toin
