...
class MemoryImpactTelemetry:
    ...
    def record_impact(cls, org_id: str, workspace_id: str, tokens_saved: int, success_lift: float):
        ...
        logger.info(f"MemoryImpact [org={org_id}]: saved {tokens_saved} tokens, lift={success_lift}")
    ...
    def get_metrics_for_org(cls, org_id: str) -> dict:
        ...
        return {
            ...
            "average_success_lift": sum(e.success_lift for e in org_events) / max(1, len(org_events)),
