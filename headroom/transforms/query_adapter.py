...
# Keys match TaskType enum values from headroom.prediction.feature_extractor.TaskType
...
def detect_query_hint(text: str) -> CompressionHint:
    ...
    """
    try:
        from headroom.prediction.feature_extractor import PromptFeatureExtractor
