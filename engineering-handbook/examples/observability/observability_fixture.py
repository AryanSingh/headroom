...
def main() -> None:
    event = {"trace_id": "tr-atlas-019", "tenant_ref": "tenant-hash-4a", "outcome": "queued", "queue_age_ms": 4200}
    ...
    assert "token" not in serialized and "secret" not in serialized and "invoice_content" not in serialized
