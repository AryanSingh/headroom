...
/**
 * Java client for the Headroom AI context compression proxy.
 *
 * <p>Headroom reduces LLM API token usage by 60-95% by compressing prompt context
 ...
 *
 * // Proxy a request through Headroom
 ...
 * <pre>{@code
 * HeadroomClient client = new HeadroomClient("http://localhost:8080");
 * HttpTransport transport = new HeadroomHttpTransport(client);
...
public class HeadroomClient {
    ...
    /**
     * Creates a new Headroom client.
     *
     * @param proxyUrl URL of the running Headroom proxy (e.g. "http://localhost:8080")
     */
    public HeadroomClient(String proxyUrl) {
        this(proxyUrl, 10_000, 60_000);
    }

    /**
     * Creates a new Headroom client with custom timeouts.
     *
     * @param proxyUrl        URL of the running Headroom proxy
     * @param connectTimeoutMs Connection timeout in milliseconds
     * @param readTimeoutMs    Read timeout in milliseconds
     */
    public HeadroomClient(String proxyUrl, int connectTimeoutMs, int readTimeoutMs) {
    ...
    /**
     * Proxies an HTTP request through the Headroom proxy.
     *
