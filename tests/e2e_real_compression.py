...
Cutctx only compresses content the model has already seen — assistant
...
def main() -> int:
    ...
    proc = subprocess.Popen(
        ...
        env={**os.environ, "CUTCTX_REQUIRE_RUST_CORE": "true"},
        stdout=log_fp,
    ...
    try:
        ...
        time.sleep(1.5)
        canonical_log = Path.home() / ".cutctx" / "logs" / "proxy.log"
