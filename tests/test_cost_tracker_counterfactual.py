...
def test_no_cost_without_cutctx_field():
    """cost_without_cutctx_usd should NOT be in stats (removed to avoid confusion)."""
    from cutctx.proxy.server import CostTracker
    ...
    assert "cost_without_cutctx_usd" not in stats
