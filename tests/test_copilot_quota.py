"""Unit tests for cutctx.subscription.copilot_quota."""
...
from cutctx.subscription.copilot_quota import (
...
class TestCopilotQuotaPollLoopLeak:
    ...
    async def test_poll_loop_does_not_leak_event_wait_tasks(self, monkeypatch):
        ...
        from cutctx.subscription.copilot_quota import _CopilotQuotaTracker
