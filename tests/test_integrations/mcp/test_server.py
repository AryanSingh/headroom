...
These tests verify that Cutctx correctly compresses MCP tool outputs
...
class TestMCPClientWrapper:
    ...
    async def test_wrapper_compresses_automatically(self, mock_mcp_client):
        ...
        wrapper = CutctxMCPClientWrapper(mock_mcp_client)
...
class TestMCPCustomProfiles:
    ...
    def test_custom_profile(self):
        ...
        compressor = CutctxMCPCompressor(profiles=custom_profiles)
