# Coding-agent protocol replay

This suite replays sanitized, structurally faithful Codex, Claude, and OpenCode requests
...
- OpenCode-compatible Chat Completions full-history resume after restart.
