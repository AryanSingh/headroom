...
``CUTCTX_PROXY_PYTHON_FORWARDER_MODE=legacy_json_kwarg`` for emergency
...
def test_python_forwarder_mode_default_is_byte_faithful(
    ...
    monkeypatch.delenv("CUTCTX_PROXY_PYTHON_FORWARDER_MODE", raising=False)
...
def test_python_forwarder_mode_invalid_raises(
    ...
    monkeypatch.setenv("CUTCTX_PROXY_PYTHON_FORWARDER_MODE", "garbage")
    with pytest.raises(ValueError, match="CUTCTX_PROXY_PYTHON_FORWARDER_MODE"):
        get_python_forwarder_mode()
...
def test_python_forwarder_mode_legacy_value_accepted(
    ...
    monkeypatch.setenv("CUTCTX_PROXY_PYTHON_FORWARDER_MODE", "legacy_json_kwarg")
...
def test_log_outbound_request_emits_structured_fields() -> None:
    ...
    proxy_logger = logging.getLogger("cutctx.proxy")
...
def test_openai_chat_memory_disabled_mode_no_op(
    ...
    monkeypatch.setenv("CUTCTX_MEMORY_INJECTION_MODE", "disabled")
    config = ProxyConfig(
        optimize=False,
        cache_enabled=False,
        rate_limit_enabled=False,
