...
from cutctx.learn.base import LearnPlugin
from cutctx.learn.registry import (
    auto_detect_plugins,
...
from cutctx.learn.scanner import ConversationScanner
...
class TestPluginCreateWriter:
    def test_all_plugins_create_valid_writers(self):
        from cutctx.learn.writer import ContextWriter
