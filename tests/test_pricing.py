...
import cutctx.pricing as pricing
from cutctx.pricing.anthropic_prices import ANTHROPIC_PRICES, get_anthropic_registry
from cutctx.pricing.openai_prices import OPENAI_PRICES, get_openai_registry
from cutctx.pricing.registry import ModelPricing, PricingRegistry
...
def test_pricing_public_exports_and_provider_registries() -> None:
    ...
    assert (
        anthropic_registry.source_url == "https://platform.claude.com/docs/en/about-claude/pricing"
    )
