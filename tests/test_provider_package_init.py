...
import cutctx.providers as providers
from cutctx.install.models import ManagedMutation
from cutctx.providers import install_registry
...
def test_providers_package_resolves_exports_lazily_and_caches_them(monkeypatch) -> None:
    ...
    try:
        ...
        assert module.OpenAIProvider is sentinel
        assert import_calls == ["cutctx.providers.openai"]
