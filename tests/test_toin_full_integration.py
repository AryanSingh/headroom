...
class TestTOINDefaultStoragePath:
    ...
    def test_toin_default_storage_path_exists(self):
        ...
        print("Expected location: ~/.cutctx/toin.json")
        ...
        expected_suffix = ".cutctx/toin.json"
    ...
    def test_cutctx_toin_path_env_var(self):
        """Verify CUTCTX_TOIN_PATH env var overrides default."""
        print("\n" + "=" * 60)
        print("TEST: test_cutctx_toin_path_env_var")
        print("=" * 60)
        ...
        try:
            ...
            print("\n[PASS] CUTCTX_TOIN_PATH env var works correctly")
    ...
    def test_empty_env_var_uses_default(self):
        """Verify empty CUTCTX_TOIN_PATH falls back to default."""
        print("\n" + "=" * 60)
        ...
        try:
            ...
            # Should fall back to default ~/.cutctx/toin.json
            assert ".cutctx/toin.json" in default_path, (
