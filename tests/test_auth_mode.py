"""Python parity tests for ``cutctx.proxy.auth_mode.classify_auth_mode``.

Mirrors the Rust matrix in ``crates/cutctx-core/tests/auth_mode.rs``
...
from cutctx.proxy.auth_mode import (
