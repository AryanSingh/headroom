...
from cutctx.memory import storage_router as sr_mod
...
def patch_backend(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import cutctx.memory.backends.local as _local_mod
...
# (x-cutctx-project-id / x-cutctx-cwd / system-prompt cwd:) must
