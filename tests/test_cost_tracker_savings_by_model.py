...
import cutctx.pricing.litellm_pricing
...
def test_cost_tracker_savings_by_model():
    ...
    tracker.record_tokens("claude-3-opus-20240229", tokens_saved=1000, tokens_sent=5000, cache_read_tokens=1000, cache_write_tokens=0, uncached_tokens=4000)
    tracker.record_tokens("claude-3-opus-20240229", tokens_saved=2000, tokens_sent=1000, cache_read_tokens=0, cache_write_tokens=0, uncached_tokens=1000)
    tracker.record_tokens("gpt-4o", tokens_saved=5000, tokens_sent=2000, cache_read_tokens=0, cache_write_tokens=0, uncached_tokens=2000)
