...
``cutctx mcp serve`` writes every compress / retrieve invocation to a
...
``cutctx_compress`` directly.

These tests pin the aggregation logic in
:func:`cutctx.proxy.cost._aggregate_mcp_events`.
"""
