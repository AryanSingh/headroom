...
def _make_test_keys(monkeypatch):
    ...
    monkeypatch.setenv("HEADROOM_LICENSE_PRIVATE_KEY", priv_bytes.hex())
    monkeypatch.setenv("HEADROOM_LICENSE_PUBLIC_KEY", pub_bytes.hex())
    monkeypatch.setenv("HEADROOM_LICENSE_KID", "test-kid")
...
class TestResidencyVerify:
    ...
    def test_verify_with_wrong_public_key(self, monkeypatch):
        ...
        monkeypatch.setenv("HEADROOM_LICENSE_PRIVATE_KEY", priv_a_bytes.hex())
        monkeypatch.setenv("HEADROOM_LICENSE_PUBLIC_KEY", priv_a.public_key().public_bytes(
            encoding=serialization.Encoding.Raw,
            format=serialization.PublicFormat.Raw,
        ).hex())
        monkeypatch.setenv("HEADROOM_LICENSE_KID", "test-kid-a")
        ...
        monkeypatch.setenv("HEADROOM_LICENSE_PRIVATE_KEY", priv_b_bytes.hex())
        monkeypatch.setenv("HEADROOM_LICENSE_PUBLIC_KEY", pub_b_bytes.hex())
        monkeypatch.setenv("HEADROOM_LICENSE_KID", "test-kid-b")
