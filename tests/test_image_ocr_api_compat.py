...
`cutctx/image/compressor.py` adapts both at runtime via
...
from cutctx.image import compressor as compressor_module
...
def test_ocr_extract_v3_mismatched_lengths_logs_and_returns_none(
    ...
    c = _make_compressor()
    with caplog.at_level("WARNING", logger="cutctx.image.compressor"):
