...
This module is new (no modifications to existing Python under `cutctx/`).
...
LOG = logging.getLogger("cutctx.parity.recorder")
...
def record_all(root: Path | None = None) -> dict[str, str]:
    ...
    try:
        from cutctx.transforms import content_detector as _cd_mod
