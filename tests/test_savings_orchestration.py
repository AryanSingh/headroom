...
class TestSavingsSource:
    def test_all_five_sources_present(self):
        ...
        # §WS11 step 5): the 5-source model grew to 7 (WS2 Phase 1) and
        # now to 8 (WS11 MEMOIZATION). Future sources (WS10/WS13/WS16/etc.)
        # will add more. This test asserts the baseline 7 + the WS11
        # MEMOIZATION source is present, but no longer hard-codes the
        ...
        # The WS11 MEMOIZATION source is the new addition this PR
