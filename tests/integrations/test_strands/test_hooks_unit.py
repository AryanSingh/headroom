"""Unit tests for Strands CutctxHookProvider.

These tests use mocks and do NOT require AWS credentials or strands-agents.
They test the internal logic of CutctxHookProvider in isolation.
...
class TestHeadroomHookProviderInit:
    ...
    def test_init_creates_default_config_if_none(self):
        ...
        assert isinstance(hook.config, CutctxConfig)


class TestRegisterHooks:
    """Tests for CutctxHookProvider.register_hooks method."""
